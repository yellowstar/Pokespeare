...
{
	public class ShakespeareTranslator : TranslationBase, ITranslationProvider
	{
		public ShakespeareTranslator(ILoggerFactory loggerFactory, ITranslationApi translationApi) : base(translationApi, loggerFactory, Models.Translation.Shakespeare, "shakespeare")
		{
		}
