...
{
	public class YodaTranslator : TranslationBase, ITranslationProvider
	{
		public YodaTranslator(ILoggerFactory loggerFactory, ITranslationApi translationApi) : base(translationApi, loggerFactory, Models.Translation.Yoda, "yoda")
		{
		}
